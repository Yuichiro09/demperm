...
export function ProfileSelf() {
  // Chaque état correspond à une future source serveur : profils, infos perso et préférences seront hydratés par l'API.
  ...
  // Ce handler mappe chaque champ de la carte Infos (prénom, nom, pseudo, email, zone…) vers le header du profil.
  ...
  // La bio reste contrôlée pour pouvoir sauvegarder le texte dès que l’API existera.
